...
contract ERC20 is IERC20, IERC20Metadata {
    ...
    /// @notice postcondition forall (address user) __verifier_old_uint(_balances[user]) == _balances[user] || (false || false || false)
    ...
    /// @notice postcondition forall (address user) __verifier_old_uint(_balances[user]) == _balances[user] || (true || false || false)
    ...
    /// @notice precondition block.number >= 0
    /// @notice precondition amount >= 0
    /// @notice postcondition forall (address user) __verifier_old_uint(_balances[user]) == _balances[user] || (false || true || false)
    ...
    /// @notice precondition block.number >= 0
    /// @notice precondition amount >= 0
    /// @notice postcondition forall (address user) __verifier_old_uint(_balances[user]) == _balances[user] || (false || false || true)
